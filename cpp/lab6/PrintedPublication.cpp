...
{
    cout << "[Default Constructor]: Constructor was called for PrintedPublication object." << endl;
}
    ...
    : m_name(name), m_type(type), m_pageCount(pageCount), m_state(PublicationState::Unpublished), m_price(price), m_ratesSize(ratesSize)
{
    ...
    cout << "[Parametrized Constructor]: Constructor was called for PrintedPublication object." << endl;
}
...
PrintedPublication::~PrintedPublication()
{
    delete[] m_rates;
    m_rates = nullptr;
    cout << "[Destructor]: Destructor was called for PrintedPublication object." << endl;
}
    ...
    : m_name(original.m_name), m_type(original.m_type), m_pageCount(original.m_pageCount), m_state(original.m_state), m_price(original.m_price), m_ratesSize(original.m_ratesSize)
{
    ...
    cout << "[Copy Constructor]: Constructor was called for PrintedPublication object." << endl;
}
...
void PrintedPublication::setCirculation(unsigned int newCirculation)
{
    if (newCirculation <= 0)
    {
        cerr << "Error: To update enter the valid circulation count." << endl;
